...
static void PF_printhello(void)
{
	char* s;
	client_t* client;
	int	entnum;
...
static void PF_DrawString(void)
{
	char* s;
	client_t* client;
	int	entnum;
...
==============
*/
static void PF_gethelditem(void)
{
	G_INT(OFS_RETURN) = PR_SetEngineString(inv_slots[inv_highlight_x][inv_highlight_y].name);
}
...
==============
*/
static void PF_isfull(void)
{
	G_FLOAT(OFS_RETURN) = Inventory_Full();
...
==============
*/
static void PF_setreticle(void)
{
	ui_reticle_base = G_FLOAT(OFS_PARM0);
	//printf("setting reticle\n");
}
...
==============
*/
static void PF_getreticle(void)
{
	G_FLOAT(OFS_RETURN) = ui_reticle_size;
}
